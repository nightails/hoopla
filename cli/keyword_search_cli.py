...
from keyword_search.search_utils import (
    BM25_K1,
    bm25_idf_command,
    bm25_tf_command,
    BM25_B,
...
def main() -> None:
    ...
    search_parser = subparsers.add_parser("keyword_search", help="Search movies using BM25")
    ...
    tf_parser.add_argument("term", type=str, help="Term to keyword_search for")

    idf_parser = subparsers.add_parser("idf", help="Get document frequency for a term")
    idf_parser.add_argument("term", type=str, help="Term to keyword_search for")
    ...
    tfidf_parser.add_argument("term", type=str, help="Term to keyword_search for")
    ...
    bm25search_parser.add_argument("term", type=str, help="Term to keyword_search for")
